                ...
                @auth
                        ...
                        <div class="collapse navbar-collapse" id="navbar-menu">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <a class="nav-link" href="{{ route('articles.home') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="nav-link-icon d-md-none d-lg-inline-block" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(115, 127, 141, 1);transform: ;msFilter:;">
                    ...
                    @elseif (Auth::user()->hasRole('teacher'))
                        ...
                        <div class="collapse navbar-collapse" id="navbar-menu">
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item dropdown">
                                    <a class="nav-link" href="{{ route('teacher.courses.home') }}" >
